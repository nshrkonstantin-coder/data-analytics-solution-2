  ...
  const faqs = [
    {
      ...
      answer:
        "Стоимость зависит от объёма проекта. Простой сайт-визитка с записью — от 50 000 ₽, CRM-система — от 200 000 ₽, мобильное приложение — от 150 000 ₽. Обсудим ваш проект и сделаем точный расчёт.",
    },
    {
      question: "Сколько времени занимает разработка?",
      answer:
        "Простой сайт — 1-2 недели, CRM-система — 1-2 месяца, мобильное приложение — 2-3 месяца. Сроки зависят от сложности и количества функций.",
    },
    {
