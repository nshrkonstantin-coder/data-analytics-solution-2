...
const defaultContent: Record<string, Record<string, string>> = {
  ...
  process: {
    ...
    description: 'Применяем инженерный подход из авторемонта к созданию digital-продуктов: диагностируем, планируем, реализуем, тестируем и обеспечиваем поддержку.',
    step1_title: 'Диагностика и анализ',
    step1_description: 'Как в автосервисе: сначала проводим полную диагностику бизнес-задач, анализируем потребности и разрабатываем техническое задание.',
    step2_title: 'Проектирование и разработка',
    step2_description: 'Создаем архитектуру решения, интерфейс и реализуем функционал. Каждый этап согласовывается с клиентом.',
    step3_title: 'Тестирование и запуск',
    step3_description: 'Проводим комплексное тестирование, устраняем ошибки и запускаем проект. Как тестирование авто после ремонта.',
    step4_title: 'Поддержка и обслуживание',
    step4_description: 'Обеспечиваем техническую поддержку, мониторинг и развитие проекта. Гарантийное и постгарантийное обслуживание.',
  },
  contact: {
