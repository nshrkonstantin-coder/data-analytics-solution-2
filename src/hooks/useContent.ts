...
const defaultContent: Record<string, Record<string, string>> = {
  hero: {
    ...
    description: 'Мы создаем производительные веб-приложения, сайты и мобильные приложения с той же точностью и надежностью, с которой обслуживаем автотранспорт.',
