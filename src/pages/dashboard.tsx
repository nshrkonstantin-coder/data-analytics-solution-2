          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-heading text-xl font-bold text-white">Мои документы</h3>
                  <p className="text-sm text-muted-foreground">Согласия и политики</p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
                Согласие на ОПД и Политика конфиденциальности
              </p>
            </Link>

            <Link
              to="/dashboard/kp-request"
              className="bg-card/50 backdrop-blur-xl border border-primary/20 rounded-2xl p-6 hover:border-primary/40 transition-all duration-300 hover:-translate-y-1 group"
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-heading text-xl font-bold text-white">Запросить КП</h3>
                  <p className="text-sm text-muted-foreground">Коммерческое предложение</p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
                Заполните реквизиты и получите КП от ООО «ДДМАКСИ СТРОЙРЕМСЕРВИС» в PDF
              </p>
            </Link>

            <Link
              to="/dashboard/contract-request"
              className="bg-card/50 backdrop-blur-xl border border-primary/20 rounded-2xl p-6 hover:border-primary/40 transition-all duration-300 hover:-translate-y-1 group"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center group-hover:bg-blue-500/20 transition-colors">
                  <Icon name="FileClock" size={24} className="text-blue-400" />
                </div>
                <div>
                  <h3 className="font-heading text-xl font-bold text-white">Запросить договор</h3>
                  <p className="text-sm text-muted-foreground">На покупку товара</p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
                Оформление договора на покупку товара у ООО «ДДМАКСИ СТРОЙРЕМСЕРВИС»
              </p>
            </Link>
          </div>
        </div>
