          ...
          {products.length === 0 ? (
            ...
            <>
              <div className="flex flex-wrap gap-2 mb-6">
                {['Все', 'Для компаний', 'Игры', 'Услуги', 'Охрана Труда', 'Промышленная Безопасность', 'Окружающая Среда', 'Пожарная Безопасность', 'Разное', 'Бизнес', 'Производство', 'Горно-рудная промышленность', 'Цифровой помощник', 'Корпоративные', 'Переводчик', '1С категория', 'Соцсети'].map((cat) => {
